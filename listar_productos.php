...
<form method="">
 ...
 <tr>
    ...
    if($sql->rowCount()> 0){
        ...
        foreach($sql ->fetchAll() as $usuarios):
            ...
            <tr>
                ...
                <td><a class="btn btn-danger btn-sm" href="apagar_producto.php?id=<?php echo $usuarios['id_stock']?>" role="button">Apagar</a></td>
             </tr>
            <?php
            endforeach;
    ...
    <div class="d-flex justify-content-center margemFooterButton">
        <a href="index.php" id="botao" role="button" class="btn btn-primary">Voltar</a>
    </div>
